...
public class PlayerStatusUI : MonoBehaviour
{
    ...
    public void HighlightPerk(RPG_CharPerkButton _currentPerk)
    {
        ...
        if (_currentPerk.type == RPG_CharPerkButton.Type.TemporaryModifier)
        {
            ...
            smallTooltip_LeftHandedLabel.text = $"{currentPerkButton.statusEffect.GetTitlePerk()} {timerString}";
            ...
            {
                smallTooltip_RightHandedLabel.text = Hypatios.RPG.GetDescription(_currentPerk.statusEffect.category, value);
            }
