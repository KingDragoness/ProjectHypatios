...
{
    const string privateCode = "oDXEZRrZRkCzjVkAFw_RXAt2bq5p4uskqD-3l2J_l62w";  //Key to Upload New Info
    const string publicCode = "6231b4d88f40bc123c2740aa";   //Key to download
