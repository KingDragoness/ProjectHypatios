...
namespace WaypointsFree
{
    ...
    public class WaypointsTraveler : MonoBehaviour
    {
        ...
        public PositionConstraint RotationConstraint = PositionConstraint.XYZ;
        ...
        {
            travelIndexCounter = i;
            Move(true);
            SetNextPosition();
        }

        public void SetInverseIndex()
        {
        ...
        void UpdateLookAtRotation()
        {
            ...
            if (RotationConstraint == PositionConstraint.XY)
            {
            ...
            else if (RotationConstraint == PositionConstraint.XZ)
            {
