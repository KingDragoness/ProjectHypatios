...
namespace UnityEngine.AI
{
    ...
    public class NavMeshSurface : MonoBehaviour
    {
        ...
        List<NavMeshBuildSource> CollectSources()
        {
            ...
            {
                Debug.Log("navmeshsurfacetest123");
            ...
            if (true)
            {
                sources.RemoveAll((x) =>
                {
                    bool isStaticNavMesh = false;
                    if (x.component != null) isStaticNavMesh = GameObjectUtility.AreStaticEditorFlagsSet(x.component.gameObject, StaticEditorFlags.NavigationStatic);
                    return (isStaticNavMesh == false);
                }
                );
            }
            #endif
