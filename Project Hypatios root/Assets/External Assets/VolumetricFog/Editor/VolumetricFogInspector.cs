...
namespace VolumetricFogAndMist {
    ...
    public class VolumetricFogInspector : Editor {
        ...
        SerializedProperty fogRenderer, _preset, _profile, _profileSync, _sun, _useFogVolumes, _showInSceneView;
        ...
        public override void OnInspectorGUI() {
            ...
            if (expandFogGeometrySection) {
                ...
                EditorGUILayout.PropertyField(_heightFallOff, new GUIContent("Height FallOff", "Height density or falloff (default = 0.6)."));
...
#pragma warning disable 0162
                    if (VolumetricFog.LIGHT_SCATTERING_BLUR_ENABLED) {
                        ...
                        EditorGUILayout.BeginHorizontal();
                        EditorGUILayout.LabelField("   Blur Downscale", GUILayout.Width(130));
                        DrawFeatureIsDisabled();
                        EditorGUILayout.EndHorizontal();
                    }
#pragma warning restore 0162
                    if (_lightScatteringExposure.floatValue > 0) {
