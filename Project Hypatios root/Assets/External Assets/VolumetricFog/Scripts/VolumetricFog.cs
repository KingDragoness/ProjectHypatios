...
namespace VolumetricFogAndMist {
    ...
    public partial class VolumetricFog : MonoBehaviour {
        ...
        const string VFM_BUILD_HINT = "VFMBuildHint100RC1";
        ...
        void UpdateMaterialPropertiesNow(Camera mainCamera) {
            ...
            float camMaxFogLength = Mathf.Min(mainCamera.farClipPlane, _maxFogLength);
            float maxFogLengthFallOff = camMaxFogLength - camMaxFogLength * _maxFogLengthFallOff + 1.0f;
            fogMat.SetVector("_FogDistance", new Vector4(scale * scale * _distance * _distance, (_distanceFallOff * _distanceFallOff + 0.1f), camMaxFogLength, maxFogLengthFallOff));
            UpdateMaterialFogColor();
        ...
        void UpdateSkyColor(float alpha) {
            ...
            //float skyIntensity = (_lightIntensity + sunLightIntensity) * Mathf.Clamp01(1.0f - _lightDirection.y * 2f); // was * 1f
            //if (skyIntensity < 0) {
            //    skyIntensity = 0;
